...
人の世界とコンピューターの世界には大きなギャップがある。Smalltalkでは、コンピューターの中に、人の世界に近いモデルを作り、そのギャップを埋める。それが、オブジェクト指向だ。従来高級言語と言われたものは、英語でプログラムをかけるようにする(Grace Hopper)、数学的な記法でプログラムを書けるようにする(John Backus)ということから始まっている。これもギャップを埋める戦略だ。それを次の段階に進めるたのがオブジェクト指向である。そのオブジェクト指向も、だいぶ手垢がついている。

ここでは、オブジェクト指向の歴史を辿りながら、OOPとは何だったのかを考えてみたい。

## ギャップを埋める

1940年代、プログラミングは機械語で行われていた。人間が機械の言葉を話す時代である。Grace Hopperはこの状況に異を唱えた最初の人物の一人だった。コンピューターは算術だけでなく言葉も処理できる。その洞察から、1952年にA-0 System（最初のコンパイラ）が生まれ、1958年のFLOW-MATIC（英語的記法の先駆）を経て、1959年のCOBOLへとつながっていく[^hopper]。後年Hopperは当時をこう振り返っている。「動くコンパイラを持っていたが、誰も手を付けようとしなかった。コンピューターは算術しかできないと言われた」。人間の言葉でプログラムを書くという発想自体が、当時は異端だったのだ。

John Backusは別の角度からこのギャップに取り組んだ。1957年に公開されたFORTRANは、FORmula TRANslation——数式をそのままプログラムに翻訳するという思想を体現していた[^fortran]。科学者や技術者が、慣れ親しんだ数学の記法でプログラムを書けるようにする。Hopperが「言葉の人」のためにギャップを埋めたのに対し、Backusは「数式の人」のためにギャップを埋めたと言える。興味深いことに、Backus自身は後に1977年のチューリング賞講演 "Can Programming Be Liberated from the von Neumann Style?" でフォン・ノイマン・スタイルの限界を指摘することになる。記法を変えても本質的な制約は残るという認識の萌芽が、そこにはあった。

HopperもBackusも「記法」を人間に近づけた。これは重要な進歩だった。しかし、プログラミングのパラダイムそのものは変わらなかった。プログラムは依然として「手続きの列」であり、人間が問題を手順に分解して機械に指示するという構造は維持されていた。1968年にDijkstraが "Go To Statement Considered Harmful"[^dijkstra-goto] で提唱した構造化プログラミングも、この枠組みの中で制御フローを整理する試みだったと言える。つまり、記法が英語的になっても数学的になっても、あるいは制御構造が整理されても、人間はまだ「機械に手順を教える」という構図の中にいたのである。

Alan Kayは、記法ではなくパラダイムそのものを変えようとした。1972年のSmalltalk-72は、コンピューターの中に人の世界に近いモデルを構築し、オブジェクト同士がメッセージで対話するという新しい世界観を提示した。手順を指示するのではなく、世界を記述する。それは発想の根本的な転換だった。しかし、このパラダイムの種はKayの独創ではなかった。その起源は、1960年代のノルウェーにまで遡ることになる。
...
初めてオブジェクト指向に触れたのは、Digitalk Smalltalk/Vで、30年以上前のことになる。アセンブラ、C、Smalltalk、C++、Java、C#、Goと渡り歩いてきたなかで割と早い出会いだった。入り口がSmalltalkだったせいで、自分のオブジェクト指向観には偏りがある。この記事もその偏りの上に書かれている。そして今はGoだ。

Go公式FAQ[^go-faq]は、「Goは、オブジェクト指向言語ですか？」という問いに、こう答えている。

> Yes and no. Although Go has types and methods and allows an object-oriented style of programming, there is no type hierarchy.
>
> （イエスでもありノーでもある。Goは型とメソッドを持ち、オブジェクト指向スタイルのプログラミングを可能にするが、型階層は存在しない）

この問いに、明快な答えはない。しかし、ここまで辿ってきた歴史を振り返ると、この問い自体があまり意味を持たないことに気づく。OOPには確固たる定義がない。Kayにとってはメッセージング、Stroustrupにとってはデータと操作の統合、教科書にとってはカプセル化・継承・多態性。どれも正しく、どれも全体像ではない。OOPは理論から演繹された体系ではなく、現場の格闘から帰納的に生まれたものだからだ。
...
[^hopper]: Grace Hopper — A-0 System（1952）、FLOW-MATIC（1958）を開発し、COBOL（1959-60）の設計にも影響を与えた。「動くコンパイラを持っていたが、誰も手を付けようとしなかった。コンピューターは算術しかできないと言われた」。<https://news.yale.edu/2017/02/10/grace-murray-hopper-1906-1992-legacy-innovation-and-service>
[^fortran]: John Backus, FORTRAN（1957）。FORmula TRANslation。1977年チューリング賞講演 "Can Programming Be Liberated from the von Neumann Style?" では、フォン・ノイマン・スタイルのプログラミングの限界を論じた。<https://dl.acm.org/doi/10.1145/359576.359579>
[^dijkstra-goto]: Edsger Dijkstra, "Go To Statement Considered Harmful" (1968)。Communications of the ACM掲載。構造化プログラミングを提唱し、goto文に依存しない制御フローの重要性を主張した。<https://dl.acm.org/doi/10.1145/362929.362947>
